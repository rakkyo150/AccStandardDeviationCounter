...
This is a custom counter for [CountersPlus](https://github.com/rynan4818/tournament_overlay) that displays the standard deviation of center precision.
...
## How to install
1. download AccStandardDeviationCounter.dll from [Releases]()
2. Add AccStandardDeviationCounter.dll to the Plugins folder under the Beat Saber installation folder.
